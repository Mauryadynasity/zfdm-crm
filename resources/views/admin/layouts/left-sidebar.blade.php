    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
        ...
        <li class="{{Request::is('admin/prospect-permission') ? 'active treeview' : ''}}"><a href="{{url('admin/prospect-permission')}}"><i class="fa fa-lock" aria-hidden="true"  style="font-size:20px"></i><span>{{__('messages.Prospect Permission')}}</span></a>
        </li>
        </li>
        @endif
      </ul>

...
class QuotationController extends Controller {
	...
	public function searchQuotation(Request $request){
		...
		$quotations = Quotation::whereBetween('created_at', [$request->fromDate, $toDate])->orderBy('id','DESC')->get();
		$returnHTML = view('admin.quotation.quotation-list',compact('quotations'))->render();
		return response()->json(array('success' => true, 'html'=>$returnHTML));
	}
}
